...
class AddNewMedicalScreen extends StatefulWidget {

  const AddNewMedicalScreen({
    super.key,
   });

  @override
  State<AddNewMedicalScreen> createState() => _AddNewMedicalScreenState();
}

class _AddNewMedicalScreenState extends State<AddNewMedicalScreen> {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Obx(()=>PrimaryButton(
                    isLoading: medicalController.loading.value ,
                    ...
                    onPressed: () {
                      if (formKey.currentState!.validate()) {
                        _pickedImagePath == null
                            ...
                            : {
                          medicalController.addMedical(MedicalModel(
